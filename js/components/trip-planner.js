...
export class TripPlanner {
  constructor(subdestination, id, date) {
  ...
  static changeTitle() {
    const tripPlannerTitle = document.querySelector(
      ".trip-planner__heading-title"
    );

    tripPlannerTitle.addEventListener(
      "keydown",
      (e) => {
    ...
    document.addEventListener(
      ...
      () => {
        if (localStorage.getItem("trip-planner-title")) {
          tripPlannerTitle.textContent = localStorage.getItem(
            "trip-planner-title"
          );
        }
      },
  ...
  static displaySubdestination() {
    ...
    subdestination.forEach((destination) =>
      TripPlanner.addSubdestinationToList(destination)
    );
  }

  static addSubdestinationToList(destination) {
    const listContainer = document.querySelector(
      ".trip-planner__subdestination-list"
    );
    const docFrag = document.createDocumentFragment();
  ...
  static displayDestination() {
    ...
    StoredDestination.forEach((destination) =>
  ...
  static addDestination(destination) {
    const destinationList = document.querySelector(
      ".trip-planner__destination-list-items"
    );
    const docFrag = document.createDocumentFragment();
    ...
    div.classList.add(
      "trip-planner__destination",
      "trip-planner__destination--filled",
      "trip-planner__destination-list--filled"
    );
  ...
  static sortList() {
    const destinationList = document.querySelector(
      ".trip-planner__destination-list"
    );
